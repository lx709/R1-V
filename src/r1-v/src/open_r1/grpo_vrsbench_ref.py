...
def main(script_args, training_args, model_args):
    ...
    train_dataset = load_from_disk('/ibex/project/c2106/Xiang/VRSBench/RL_data//VRSBench_RL_train_ref_1k')
    test_dataset = load_from_disk('/ibex/project/c2106/Xiang/VRSBench/RL_data//VRSBench_RL_train_ref_1k')
    dataset = DatasetDict({
        'train': train_dataset,
        'test': train_dataset,
    })
