...
export LOG_PATH="./debug_log_3b_vrsbench-ref.txt"

cd /home/lix0i/Xiang/RS/R1-V/src/r1-v

QWEN_PATH=/ibex/project/c2106/Xiang/Qwen2.5-VL-3B-Instruct/
HF_DATASET=/ibex/project/c2106/Xiang/VRSBench/RL_data/VRSBench_RL_train_ref_1k/
OUTPUT_DIR=outputs/VRSBench_Qwen2.5-VL-3B-ref
RUN_NAME=VRSBench_Qwen2.5-VL-3B-ref
